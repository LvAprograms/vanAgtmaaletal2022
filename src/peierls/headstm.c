...
#define MAXXLN  	2101 			 /* Max vertical line num in Grid */
#define MAXYLN  	601 			 /* Max horizontal line num in Grid */
...
#define MAXMRK   	80000000 		 /* Max total marker Num */
#define MAXBON    	MAXPAR 		 	 /* Max Total bondary condition Equations for all grid */
#define setup 		STM_SETUP_DEF  			 /* Model setup options: LAB: 0=lab, ... ; NATURE: 10=nature dynw,JGR, 11=nature offev,GRL */
#define ls_t0 		STM_INIPRN_DEF 			 /* For Large-Scale model: 1 = start from t=0 (geometry as defined in init.t3c, use mode_ls_to.t3c), 0 = start from prn defined at line in mode_ls_stm.t3c defined by file.t3c */
#define STM_LOG_MARKER 1
#if (setup<10)
